<?php
    ...
    if(isset($_POST) && $_POST){
        ...
        // 2 - Criando query para adicionar novo usuário na tabela usuarios
        $query = $dbh->prepare("insert into usuarios (nome, sobrenome, email, senha) values (:nome, :sobrenome, :email, :senha);");
        //variavel $dbh que instancia com a conexão do banco, troca de informações do buscando ou mandando pro banco

        // 3 - executando a query para registrar um novo usuário
